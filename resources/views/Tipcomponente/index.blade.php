...
@section('main-content')
    ...
    <div class="panel-success">
            <div class="panel-heading" style="text-align:center;">Listado de Tipo de Componente</div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Crear Tipo de Componente</h4>
            </div>
    ...
    <div class="modal fade" id="editar" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Editar Tipo de Componente</h4>
            </div>
...
<script src="{{ asset('/js/Tipcomponente/index.js') }}" type="text/javascript"></script>
